...
const About = () => {
  // Sample data for cards and testimonials (replace with actual data)
  const cardsData = [
    {
      icon: "💼",
      title: "Our Mission",
      description:
        " HealthLocator is a platform dedicated to providing accessible and reliable healthcare information to individuals around the world.",
    },
    {
      icon: "🚀",
      title: "Our Vision",
      description:
        " Our mission is to empower individuals by providing them with the necessary tools and information to make informed decisions about their healthcare needs.",
    },
    {
      icon: "🌟",
      title: "Our Values",
      description:
        "At HealthLocator, we value integrity, compassion, innovation, and inclusivity in everything we do.",
    },
  ];
  ...
  const testimonialsData = [
    {
      name: "John Doe",
      company: "XYZ Inc.",
      testimonial: "Working with Darsheel was a game-changer for our business.",
    },
    {
      name: "Jane Smith",
      company: "ABC Corp.",
      testimonial:
        "His expertise and insights have been invaluable to our growth.",
    },
  ];

  return (
    <section className="py-16 text-gray-900">
      <div className=" relative   flex items-center  n justify-center overflow-hidden z-50 ">
        <div className="relative mx-auto h-full px-4  pb-20   md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
          <div className="flex flex-col items-center justify-between lg:flex-row py-16">
            <div className=" relative ">
              <div className="lg:max-w-xl lg:pr-5 relative z-40">
                <p className="flex uppercase text-2xl  font-bold text-red-500">
                  About Us
                </p>
                <h2 className="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                  Together, We Make a
                  <span className="my-1 inline-block border-b-8 border-g4 bg-red-500 px-4 font-bold text-g4 animate_animated animate_flash">
                    Promise
                  </span>
                </h2>
                <p className="text-base text-gray-800">
                  Care Connect is committed to revolutionizing the way people
                  access healthcare services. Our platform provides a
                  comprehensive solution for individuals to quickly locate and
                  connect with healthcare facilities and professionals.
                </p>
                <div className="mt-10 flex flex-col items-center md:flex-row">
                  <a
                    href="/"
                    className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-red-500 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-red-600 focus:outline-none md:mr-4 md:mb-0 md:w-auto"
                  >
                    View More
                  </a>
                  <a
            ...
            <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="my-6 mx-auto h-10 w-10 animate-bounce rounded-full bg-red-500 p-2 lg:hidden"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth="2"
              ...
              <div className="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                <img src="https://img.freepik.com/free-vector/people-walking-sitting-hospital-building-city-clinic-glass-exterior-flat-vector-illustration-medical-help-emergency-architecture-healthcare-concept_74855-10130.jpg?t=st=1712950695~exp=1712954295~hmac=a34a3be0590eae8f2a2a48469214900629e700f8548b41e6e641e58a121168c4&w=1380" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className=" absolute -bottom-24 left-10 z-0  opacity-10 ">
          <svg
            ...
            height="800px"
            viewBox="0 0 24 24"
            className="w-96 z-0  h-full    object-fill fill-red-800 text-red-500"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
        ...
        <div className=" absolute -bottom-0 left-3/4 z-0  opacity-10 ">
          <svg
            ...
            viewBox="0 0 256 256"
            xmlns="http://www.w3.org/2000/svg"
            className="w-48 z-0  h-full -rotate-90   object-fill fill-red-800 text-red-500"
          >
            <path
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {cardsData.map((card, index) => (
            <div
              key={index}
              className="bg-red-400 border hover:border-red-500 text-center hover:bg-red-500 p-6 rounded-lg shadow-md"
            >
